...
const authApiRequest = {
  ...
  logoutFromNextClientToNextServer: (force?: boolean | undefined, signal?: AbortSignal | undefined) => http.post('/api/auth/logout', {
    force
  }, {
    baseUrl:'',
    signal
  ...
  slideSessionFromNextClientToNextServer: () => http.post<SlideSessionResType>(
